...
--
-- Host: 127.0.0.1
-- Generation Time: Aug 02, 2018 at 09:02 PM
...
CREATE TABLE `apoteker` (
  `ID_apoteker` varchar(20) NOT NULL,
...
INSERT INTO `apoteker` (`ID_apoteker`, `Nama_apoteker`, `pass`, `Alamat`, `user_level`) VALUES
('APT1', 'Erik', '$2a$08$DRfkQN0v2nrUxIlf7ebrqerP82BktwDqkq0nRkZaZDE9vGLfSVOkC', 'Bandung', 'apoteker');
...
(1, 'Tablet, Sakit Kepala', 'Paramex', 0, '2019-06-13', 4000, 1);
...
(3, 'Ai Siti Sopiah', 'wanita', 22, 'Jl Telekomunikasi', 'Mahasiswa', 82367879);
...
(1, '0000-00-00', 0, 1, 1),
(2, '2018-08-02', 2500, 1, 1),
(3, '2018-08-02', 250000, 2, 1),
(4, '2018-08-02', 250000, 2, 1);
...
--
ALTER TABLE `daftar_berobat`
  MODIFY `idBerobat` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=5;
...
--
ALTER TABLE `transaksi`
  MODIFY `idTransaksi` bigint(12) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=5;
