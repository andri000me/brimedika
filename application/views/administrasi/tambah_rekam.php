                        ...
                        <div class="card">
                            <div class="card-body">
                                <h4 class="header-title">Form Tambah Pasien</h4>
                                   <form class="form-horizontal" method="post" action="<?php echo base_url('C_Administrasi/tambah_rekam') ?>">
                                    ...
                                    <label class="col-sm-2 col-form-label">Anamnesa </label>
                                        <div class="col-sm-10">
                                            <textarea class="form-control" name="ana"  rows="5"></textarea>
                                        </div>
                                    </div> 
                                   <div class="form-group row">
                                    <label class="col-sm-2 col-form-label">Diagnosa </label>
                                        <div class="col-sm-10">
                                            <textarea class="form-control" name="diagnosa"  rows="5"></textarea>
                                        </div>
                                    </div>                                    
                                    <div class="form-group row">
                                    ...
                                    <label class="col-sm-2 col-form-label">Detail Terapi </label>
                                        <div class="col-sm-10">
                                            <textarea class="form-control" name="det"  rows="5"></textarea>
                                        </div>
                                    </div>
