                ...
                <div class="row">
                    <div class="col-12">
                        <div class="page-title-box">
                            ...
                            <?php }?>
                            <button type="button" class="btn btn-outline-primary" data-toggle="modal" data-target="#myModal">Tambah Pasien Berobat</button>                      <!-- sample modal content -->
                                    ...
                                    <div class="modal-dialog">
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-body">
                                                <form class="form-horizontal" method="post" action="<?php echo base_url('C_Administrasi/tambahGigi') ?>">
